                        ...
                        <div align="center">
                            <span>
                                ...
                                <h1 style={{
                                    margin: "0",
                                    paddingBottom: "3%"
                                }}>Receipt ID : {this.state.selectedTransaction.id}</h1>
                                Parking Lot <h1 style={{
                                margin: "0",
                                paddingBottom: "3%"
                            }}>{this.state.selectedTransaction.parkingLotName}</h1>
                                <div style={{paddingBottom: "3%"}}>
                                    <Row>
                                        <Col span={6}>
                                            Parking Level <h3 style={{
                                            margin: "0",
                                            paddingBottom: "3%"
                                        }}>{this.state.selectedTransaction.parkingLevel}</h3>
                                        </Col>
                                        <Col span={6}>
                                            Parking Position <h3 style={{
                                            margin: "0",
                                            paddingBottom: "3%"
                                        }}>{this.state.selectedTransaction.parkingPosition}</h3>
                                        </Col>
                                        <Col span={12}>
                                            Reservation Date / Time <h3 style={{
                                            margin: "0",
                                            paddingBottom: "3%"
                                        }}>{new Date(this.state.selectedTransaction.reserveTime).toLocaleString()}</h3>
                                        </Col>
                                    </Row>
                                </div>
                                <h1 style={{
                                    margin: "0",
                                    paddingBottom: "3%"
                                }}>Price : Php {this.state.selectedTransaction.price}</h1>
                            </span>
                            <hr/>
