            ...
            <div style={{display: 'flex',  justifyContent:'center', alignItems:'center', height: '50vh'}} >
                <Card style={{ width: 600, justifyContent: "center" }}>
                    <div style={{paddingBottom: "10px"}}>
                        ...
                        <Input placeholder="Enter Parking Lot Name" value={this.state.pName} onChange={this.handlePName}/>
                    </div>
                    <div style={{paddingBottom: "10px"}}>
                        <p> Parking Lot Location: </p>
                        <Input placeholder="Enter Parking Lot Location" value={this.state.pLoc} onChange={this.handlePLoc}/>
                    </div>
                    <div style={{paddingBottom: "10px"}}>
                        <p> Parking Lot Flat Rate: </p>
                        <Input placeholder="Enter Parking Lot Flat Rate" value={this.state.pFRate} onChange={this.handlePFRate}/>
                    </div>
                    <div style={{paddingBottom: "10px"}}>
                        <p> Parking Lot Capacity: </p>
                        <Input placeholder="Enter Parking Lot Capacity" value={this.state.pCap} onChange={this.handlePCap}/>
                    </div>
                    <div style={{paddingBottom: "10px"}}>
                        <p> Parking Lot Max Per Level: </p>
                        <Input placeholder="Enter Parking Lot Max Per Level" value={this.state.pMax} onChange={this.handlePMax}/>
                    </div>
